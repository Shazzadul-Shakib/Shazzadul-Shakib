  ...
  return (
    ...
    >
      ...
      <section className="grid gap-10">
        {/* Project-1 */}
        <div className="flex flex-col gap-3 my-5 md:my-10 md:flex-row md:gap-10">
          ...
          <div className=" min-h-[250px] flex flex-col justify-center items-center md:w-[60%]">
            <div>
              <div>
                <h1 className="text-[#EF403A] text-xl font-bold">Accord-AI</h1>
                <p className="text-white mt-3 text-lg">
                  This web application enables users to engage in topic-based
                  real-time conversations by joining or creating dedicated chat
                  rooms for focused discussions. Users can communicate
                  seamlessly through instant messaging, with support for message
                  deletion, online user tracking, and smooth real-time updates
                  powered by Socket.io. To enhance the chat experience, the
                  platform offers AI-generated summaries, allowing users to
                  quickly review and catch up on discussions.
                </p>
                <p className=" text-[#EF403A] my-2">
                  Technology used :{" "}
                  <span className="text-sm text-white">
                    Next.js · Tailwind · Socket.io · Axios · Shadcn · Node.js ·
                    Express.js · TypeScript · MongoDB · Mongoose · Tanstack
                    Query · JSON Web Token(JWT) · Cloudinary · AI integration
              ...
              <div className="text-center flex flex-col gap-3 justify-end items-center mt-5 md:flex-row">
                <div className=" w-full flex flex-col gap-3 md:flex-row md:w-auto">
                  <a
                    href="https://github.com/Shazzadul-Shakib/accord-ai-client"
                    target="_blank"
                  ...
                  <a
                    href="https://github.com/Shazzadul-Shakib/accord-ai-server"
                    target="_blank"
                    className="font-bold px-4 py-2 text-[#EF403A] text-sm border border-[#EF403A] rounded-md mx-2"
                  >
                    Server Side Code
                ...
                <div className="flex w-full md:w-auto">
                  <a
                    href="https://accord-ai-client.vercel.app"
                    target="_blank"
